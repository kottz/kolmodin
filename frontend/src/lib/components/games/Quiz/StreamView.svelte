<script lang="ts">
	...
	import type { QuizPublicState, RecentGuess } from './types';
	...
	function startGameOverSequence() {
		...
		gameOverTimeout = setTimeout(() => {
			...
			instructionState = {
				text: winner ? `🏆 ${winner} Wins! 🏆` : 'Quiz Complete!',
				type: 'game-over',
				winner
			};
	...
	function handlePhaseChange() {
		if (gameState.phase.type === 'Setup') {
			...
			instructionState = { text: 'Listen carefully and answer in chat!', type: 'instruction' };
	...
	<div class="relative z-10 flex h-full flex-col">
		...
		>
				...
				{#if gameOverAnimationState === 'celebration'}
					...
					<div class="flex flex-1 items-center justify-center">
						<div class="text-center" transition:scale={{ duration: 1000, easing: elasticOut }}>
							...
							<h1 class="mb-6 animate-pulse text-6xl font-bold text-white">Quiz Over!</h1>
			...
			{:else if isPlaying}
				...
				<div class="w-1/2">
					<div class="h-full rounded-2xl border border-white/10 bg-black/20 p-6 backdrop-blur-sm">
						<h2 class="mb-6 text-center text-2xl font-bold text-white">Recent Answers</h2>
						<div class="space-y-3">
			...
			{:else if gameState.phase.type === 'Setup'}
				...
				<div class="flex flex-1 items-center justify-center">
					<div class="text-center">
						...
						<h1 class="mb-2 text-4xl font-bold text-white">Setting up quiz...</h1>
					</div>
				</div>
			{:else}
				...
				<div class="flex flex-1 items-center justify-center">
					<div class="text-center">
						...
						<h1 class="mb-2 text-4xl font-bold text-white">Waiting for quiz...</h1>
					</div>
				</div>
			{/if}
		</div>
